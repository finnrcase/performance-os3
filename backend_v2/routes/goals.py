...
def goals_payload() -> dict:
    ...
    return {
        ...
        "training_workload": {"status": "deferred", "summary": "Training workload is deferred in backend_v2 startup routes.", "current": {}},
        "weight_feedback": {"status": "deferred", "suggested_adjustment": "hold", "confidence": "low"},
        "adaptive_recommendation": {
            "confidence": "deferred",
            "reasoning": ["Advanced adaptive nutrition is not part of backend_v2 core startup."],
