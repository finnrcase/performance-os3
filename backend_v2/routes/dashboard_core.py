...
def dashboard_core_payload() -> dict:
    ...
    return {
        ...
        "training_workload": {"status": "deferred", "summary": "Training workload is deferred in backend_v2 core."},
        ...
        "recovery": {"connected": False, "status": "deferred", "message": "Recovery is deferred in backend_v2 core."},
        ...
        "recommendation": {"recommendation_summary": "Advanced recommendations are deferred in backend_v2."},
        "counts": {
