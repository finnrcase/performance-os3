            ...
            rows.append(
                {
                    ...
                    "split_type": "" if is_cardio else classification.get("split_type", ""),
                    "split_confidence": 0.0 if is_cardio else classification.get("split_confidence", 0.0),
                    "classification_reason": "" if is_cardio else ",".join(classification.get("classification_reason") or []),
